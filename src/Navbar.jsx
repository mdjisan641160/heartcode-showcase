    ...
    <nav className="bg-white shadow-md sticky top-0 z-50 px-4 py-3">
      <div className="max-w-7xl mx-auto flex justify-between items-center">
        ...
        <div 
          ...
          className="text-2xl font-black text-slate-800 cursor-pointer italic"
        >
          HEART<span className="text-blue-600">CODE</span>
        </div>
        ...
        <div className="flex items-center gap-4">
          ...
          {/* হোয়াটসঅ্যাপ বাটন */}
          <a 
            href="https://wa.me/8801787171252" // এখানে আপনার নম্বর দিন
            target="_blank" 
            rel="noopener noreferrer"
            className="flex items-center gap-2 bg-[#25D366] text-white px-3 py-2 rounded-xl text-xs font-bold hover:scale-105 transition-all shadow-md"
          >
          ...
          {/* শপিং কার্ড ব্যাজ (আগে যেটা ফিক্স করেছি) */}
          <div 
            onClick={() => setView('checkout')}
            className="relative cursor-pointer p-2 bg-slate-100 rounded-full"
          >
